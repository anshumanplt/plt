...
<html lang="en">
  <head>
    ...
    <title>PrettyLovingThing Admin Login</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="{{ url('/frontend/img/1657366295logo.png') }}">
                </div>
                ...
                <form class="pt-3" action="{{ route('admin.login.submit') }}" method="POST">
                  ...
                  <div class="form-group">
                    <input type="password" class="form-control form-control-lg" required name="password" id="exampleInputPassword1" placeholder="Password">
                  </div>
                  <div class="mt-3">
