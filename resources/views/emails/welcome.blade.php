...
<head>
    ...
    <title>Welcome - Prettylovingthing</title>
                ...
                <tr>
                    <td bgcolor="white">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px 40px 30px 40px; text-align: center;"> <span style="color:#fff; font-size: 30px"><img src="https://prettylovingthing.com/frontend/img/1657366295logo.png"></span> </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td background="https://prettylovingthing.com/images/categories/1695296182_dresses.jpg" bgcolor="#222222" align="center" valign="top" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                        <div>
                                        ...
                                        <table>
                                            <tr>
                                                <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                                    <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #040404; font-weight: bold;">WELCOME {{ $data->name }},</h1>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" style="text-align: center; padding: 10px 20px 15px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #0f0e0e;">
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"> <br>
                            <tr>
                                <td align="center"> <img src="https://prettylovingthing.com/frontend/img/1657366295logo.png" width="50%" height="50" style="display: block; border: 0px;" /> </td>
                            </tr>
                            <tr>
                                <td><br></td>
                            </tr>
                            <tr>
                                <td style="padding: 0px 40px 10px 40px; font-family: sans-serif; font-size: 12px; line-height: 18px; color: #666666; text-align: center; font-weight:normal;">
                                    <p style="margin: 0;">For Any assistance you may please contact us by mail to: support@prettylovingthing.com

                                        Telephone the Help Team at PH +91 784 990 7200 Monday to Saturday between 9 AM to 9 PM
                                        
                                        You may also Contact us through WhatsApp: +91 905 788 8886</p>
                                </td>
                            </tr>
